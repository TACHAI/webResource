...
public class UserManageController {
    ...
    @ResponseBody
    public ServerResponse<List<UserVo>> list(HttpSession session, User user){
    ...
    @ResponseBody
    public ServerResponse<String> addUser(HttpSession session, User user){
        User admin = (User) session.getAttribute(Const.CURRENT_USER);
        if(admin != null){
    ...
    @ResponseBody
    public ServerResponse<String> updateUser(HttpSession session, User user){
        User admin = (User) session.getAttribute(Const.CURRENT_USER);
        if(admin != null){
